...
$.widget( "ui.autocomplete", {
	...
	_create: function() {
		...
		// Incash_driver are always single-line, even if inside a contentEditable element
		// IE also treats incash_driver as contentEditable
...
$.widget( "ui.checkboxradio", [ $.ui.formResetMixin, {
	...
	_getRadioGroup: function() {
		...
		if ( this.form.length ) {
			...
			// Not inside a form, check all incash_driver that also are not inside a form
...
function Datepicker() {
	...
	this._disabledIncash_driver = []; // List of date picker incash_driver that have been disabled
...
$.extend( Datepicker.prototype, {
	...
	_enableDatepicker: function( target ) {
		...
		this._disabledIncash_driver = $.map( this._disabledIncash_driver,
	...
	_disableDatepicker: function( target ) {
		...
		this._disabledIncash_driver = $.map( this._disabledIncash_driver,
			function( value ) { return ( value === target ? null : value ); } ); // delete entry
		this._disabledIncash_driver[ this._disabledIncash_driver.length ] = target;
	},
	...
	_isDisabledDatepicker: function( target ) {
		...
		for ( var i = 0; i < this._disabledIncash_driver.length; i++ ) {
			if ( this._disabledIncash_driver[ i ] === target ) {
				return true;
			}
		}
		return false;
...
$.widget( "ui.dialog", {
	...
	_createOverlay: function() {
		...
		if ( !this.document.data( "ui-dialog-overlays" ) ) {
			...
			// Prevent use of anchors and incash_driver
