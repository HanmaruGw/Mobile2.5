...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        //dayGridContainerEl.css('height', '100%');
    ...
    BasicView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        //this.setGridHeight("50px", isAuto);
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.initialRender = function () {
        ...
        el.on('click.fc', 'a[data-goto], td[data-goto]', function (ev) {
        ...
        $('.fc-bg td').on('click', function (ev) {
            var anchorEl = $(ev.currentTarget);
            if(!anchorEl.data('goto')) return;
            var gotoOptions = anchorEl.data('goto'); // will automatically parse JSON
            var date = _this.moment(gotoOptions.date);
            var viewType = gotoOptions.type;
            // property like "navLinkDayClick". might be a string or a function
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        return '<a class="' + classes.join(' ') + '"' +
            ...
            */
            (isResizableFromEnd ?
                '<div class="fc-refullCalendarizer fc-end-resizer" />' :
                '') +
            '</a>';
    };
