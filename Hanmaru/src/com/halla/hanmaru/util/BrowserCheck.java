package com.halla.hanmaru.util;
...
public class BrowserCheck {
	...
	public static boolean agentCheck(HttpServletRequest request) {
	...
	public boolean cookieCheck(HttpServletRequest request) {
		...
		try {
			for(int i = 0 ; i < cookies.length; i++){      
				if(cookies[i].getName().equals("isMobile") && cookies[i].getValue().equals("N")) {
					return false;
				}
			}
		} catch(Exception e) {
